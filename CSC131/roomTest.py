    ...
    if (len(words) == 2):
        ...
        if (verb == "go"):
            ...
            for i in range(len(currentRoom.exits)):
                ...
                if (noun == "sleigh" and "key" in inventory):
                    winScreen()
                else:
                    response = "something is missing, the reindeer can't pull the sleigh unless it is started"
                    counter = 0
                    createRooms()

                if(noun == "fireplace" and "toys" in inventory):
        ...
        # the verb is: look
            ...
            #Change the descriptions of the desk when items are taken from it
            if (noun == "desk" and "statue" not in currentRoom and "book" in currentRoom):
                desc = "There is a dust imprint where it seems a statue used to be. There is still a book on the desk."
                createRooms()
            elif (noun == "desk" and "statue" in currentRoom and "book"  not in currentRoom):
                desc = "There is a dust imprint where it seems a book used to be. There is still a statue on the desk."
                createRooms()
            elif (noun == "desk" and "statue" not in currentRoom and "book"  not in currentRoom):
                desc = "There are dust imprints where it seems a book and a statue used to be."
                createRooms()
        ...
        # the verb is: take
            ...
            for grabbable in currentRoom.grabbables:
                ...
                if (noun == grabbable):
                    ...
                    if(noun == 'book'):
                        desc = 'There is a dusty imprint that seems to be almost book shaped'
                        createRooms()
                    ...
                    if(noun == 'statue'):
                        ...
                        if(answer in no):
                            ...
                            desc = "There is a dusty imprint that seems to be almost statue shaped"
                            createRooms()
